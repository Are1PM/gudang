<div style="border:1px solid rgb(238,238,238); padding:10px; overflow:auto; width:1114px; height:375px;">
     ...
     <input type="button" value="Tambah" title="Tambah data kategori" onclick=window.open('home_perlengkapan.php?page=form-input-data-kategori','_self');><br><br>
     <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr bgcolor="#FF6600">
               <th width="20" height="42">No</td>&nbsp;
               <th width="100">Nama Kategori</td>&nbsp;
               <th width="100">Jumlah</td>&nbsp;
